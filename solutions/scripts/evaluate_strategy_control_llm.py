...
Usage:
    python solutions/scripts/evaluate_strategy_control_llm.py \
    ...
    for jsonl_path in args.jsonl:
        ...
        with jsonl_path.open("r", encoding="utf-8") as f:
            for line in f:
                ...
                generated_by_strategy = record.get("generated_by_strategy") or {}
                if generated_by_strategy:
                    for target_strategy, generated in generated_by_strategy.items():
                ...
                # Also support S4 CPD generation files:
                # {"strategy": "...", "generated": "...", "gold_utterance": "..."}
                target_strategy = record.get("target_strategy") or record.get("strategy")
                generated = record.get("generated")
                if target_strategy in all_strategies and generated and len(generated.strip()) >= 2:
                    samples_to_classify.append(
                        {
                            "dialogue_id": record.get("dialogue_id"),
                            "turn_index": record.get("turn_index"),
                            "gold_strategy": record.get("gold_strategy") or target_strategy,
                            "target_strategy": target_strategy,
                            "context": prompt or record.get("context", ""),
                            "utterance": generated,
                        }
                    )
