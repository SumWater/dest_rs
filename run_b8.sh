...
P1_OUT="outputs/b8/p1_lora_only"
P2_OUT="outputs/b8/p2_prefix_frozen_lora"

echo "================================================================================"
echo " B8: Phase 1 (LoRA) → Phase 2 (prefix on frozen LoRA)"
echo "================================================================================"
...
if [ -f "$P1_OUT/metrics.json" ]; then
    ...
    python train.py --config configs/b8/b8_p1_lora.json
...
if [ -f "$P2_OUT/metrics.json" ]; then
    ...
    python train.py --config configs/b8/b8_p2_prefix.json
fi
...
python scripts/evaluate_strategy_control_llm.py \
    ...
    --config configs/b8/b8_p2_prefix.json \
...
echo ""
echo "================================================================================"
echo " B8 完成 ($START_TIME → $END_TIME)"
echo ""
